    ...
    public static void main(String[] args) {
        ...
        while (!input.equals("q")) {
            ...
            if (!input.equals("q")) {
                ...
                if (popularity[0].endsWith("1"))
                    data2.add(new String[]{"звонок"});
                else if (popularity[0].endsWith("2") || popularity[0].endsWith("3") || popularity[0].endsWith("4"))
                    data2.add(new String[]{"звонка"});
                else
                    data2.add(new String[]{"звонков"});
        ...
        System.out.println("Сортировка по популярности имен: ");
        hashMapSpecialPrint(orderIndexes, data);
